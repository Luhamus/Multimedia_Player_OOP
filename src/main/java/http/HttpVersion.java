...
public enum HttpVersion {
    ...
    private static final Pattern httpVersionRegexPatern = Pattern.compile("^HTTP/(?<major>\\d+).(?<minor>\\d+)");

    //leiame sobivaima versiooni
    public static HttpVersion getBestCompatibleVersion(String literalVersion) throws BadHttpVersionException {
        Matcher matcher = httpVersionRegexPatern.matcher(literalVersion);
